...
const Navbar = () => {
  ...
  // Update navbar appearance and active section based on scroll position
  useEffect(() => {
    const handleScroll = () => {
      setScrolled(window.scrollY > 20);

      // Ignore scroll events shortly after a manual nav click
  ...
  // and a slightly transparent background on desktop when closed.
